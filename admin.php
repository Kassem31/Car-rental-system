...
WHERE user_id='$search_key' or plate_id='$search_key' or pickup_date='$search_key'or return_date='$search_key' or fee='$search_key'or email='$search_key'or user_name='$search_key' or pass='$search_key' or fee='$search_key' or manefacturing_company='$search_key'
  or status='$search_key'or price_per_day='$search_key'  ";
...
while ($tuples=mysqli_fetch_array($query))
  ...
  "</td><td>".$tuples['fee']."</td><td>".$tuples['manefacturing_company']."</td><td>".$tuples['airconditioned']."</td><td>".$tuples['status']."</td><td>".$tuples['price_per_day']."</td></tr>";
...
echo "</table>";
          ...
          $sql1="SELECT  *
          FROM  car
          WHERE   plate_id NOT IN(SELECT plate_id FROM reservation) AND  ( plate_id='$search_key' or manefacturing_company='$search_key'  or status='$search_key'or price_per_day='$search_key' )";
            ...
            echo " <table>
                  <tr>
                    ...
                    while ($tuples=mysqli_fetch_array($query1))
                      echo "<tr><td>".$tuples['plate_id']."</td><td>".$tuples['manefacturing_company']."</td><td>".$tuples['airconditioned']."</td><td>".$tuples['status']."</td><td>".$tuples['price_per_day']."</td></tr>";
                      echo "</table>";
